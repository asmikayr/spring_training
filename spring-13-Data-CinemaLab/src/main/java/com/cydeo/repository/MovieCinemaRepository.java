...
public interface MovieCinemaRepository extends JpaRepository<MovieCinema, Long> {
    ...
    List<MovieCinema> findAllByMovie_NameContaining(String pattern);
    ...
    @Query(value = "SELECT mc.* FROM movie_cinema mc JOIN cinema c ON mc.cinema_id = c.id JOIN Location l on  c.location_id = l.id where l.name = ?1", nativeQuery = true)
