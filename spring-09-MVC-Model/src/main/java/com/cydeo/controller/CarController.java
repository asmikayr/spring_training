...
public class CarController {
    ...
    //localhost:2020/info?make=Honda
@RequestMapping("/info")
    ...
    public String carInfo3(@RequestParam String make, @RequestParam int year, Model model){//localhost:2020/info3?make=Honda&year=2015
        model.addAttribute("make", make);
